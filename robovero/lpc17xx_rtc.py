...
def RTC_CntIncrIntConfig(RTCx, CntIncrIntType, NewState):
  ...
  '''
  return RoboCaller().call("RTC_CntIncrIntConfig", "void", RTCx, CntIncrIntType, NewState)
...
def RTC_ClearIntPending(RTCx, IntType):
  ...
  '''
  return RoboCaller().call("RTC_ClearIntPending", "void", RTCx, IntType)
...
def RTC_SetFullTime(RTCx, pFullTime):
  ...
  '''
  return RoboCaller().call("RTC_SetFullTime", "void", RTCx, pFullTime)
...
def RTC_SetAlarmTime(RTCx, Timetype, ALValue):
  ...
  '''
  return RoboCaller().call("RTC_SetAlarmTime", "void", RTCx, Timetype, ALValue)
...
def RTC_GetIntPending(RTCx, IntType):
  ...
  '''
  return RoboCaller().call("RTC_GetIntPending", "IntStatus", RTCx, IntType)
...
def RTC_SetTime(RTCx, Timetype, TimeValue):
  ...
  '''
  return RoboCaller().call("RTC_SetTime", "void", RTCx, Timetype, TimeValue)
...
def RTC_GetFullAlarmTime(RTCx, pFullTime):
  ...
  '''
  return RoboCaller().call("RTC_GetFullAlarmTime", "void", RTCx, pFullTime)
...
def RTC_DeInit(RTCx):
  ...
  '''
  return RoboCaller().call("RTC_DeInit", "void", RTCx)
...
def RTC_Init(RTCx):
  ...
  '''
  return RoboCaller().call("RTC_Init", "void", RTCx)
...
def RTC_ReadGPREG(RTCx, Channel):
  ...
  '''
  return RoboCaller().call("RTC_ReadGPREG", "uint32_t", RTCx, Channel)
...
def RTC_GetAlarmTime(RTCx, Timetype):
  ...
  '''
  return RoboCaller().call("RTC_GetAlarmTime", "uint32_t", RTCx, Timetype)
...
def RTC_AlarmIntConfig(RTCx, AlarmTimeType, NewState):
  ...
  '''
  return RoboCaller().call("RTC_AlarmIntConfig", "void", RTCx, AlarmTimeType, NewState)
...
def RTC_GetTime(RTCx, Timetype):
  ...
  '''
  return RoboCaller().call("RTC_GetTime", "uint32_t", RTCx, Timetype)
...
def RTC_CalibCounterCmd(RTCx, NewState):
  ...
  '''
  return RoboCaller().call("RTC_CalibCounterCmd", "void", RTCx, NewState)
...
def RTC_GetFullTime(RTCx, pFullTime):
  ...
  '''
  return RoboCaller().call("RTC_GetFullTime", "void", RTCx, pFullTime)
...
def RTC_CalibConfig(RTCx, CalibValue, CalibDir):
  ...
  '''
  return RoboCaller().call("RTC_CalibConfig", "void", RTCx, CalibValue, CalibDir)
...
def RTC_Cmd(RTCx, NewState):
  ...
  '''
  return RoboCaller().call("RTC_Cmd", "void", RTCx, NewState)
...
def RTC_SetFullAlarmTime(RTCx, pFullTime):
  ...
  '''
  return RoboCaller().call("RTC_SetFullAlarmTime", "void", RTCx, pFullTime)
...
def RTC_WriteGPREG(RTCx, Channel, Value):
  ...
  '''
  return RoboCaller().call("RTC_WriteGPREG", "void", RTCx, Channel, Value)
...
def RTC_ResetClockTickCounter(RTCx):
  ...
  '''
  return RoboCaller().call("RTC_ResetClockTickCounter", "void", RTCx)
